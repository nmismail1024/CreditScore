...
//
// Additional changes: Nur Ismail
//  - 2020/03/04: Added .superBrisk option, to speed up the animation
...
enum AnimationDuration {
    case laborious, plodding, strolling, brisk, superBrisk, noAnimation
    ...
    var value: TimeInterval {
        ...
        case .superBrisk: return 1.2    //NMI
